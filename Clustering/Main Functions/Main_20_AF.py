...
## 1/9 resolution
Clustering(method="maxp", data="af", resize=3, threshold=1325 / 9, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="af", resize=2, threshold=1325 / 4, plot=False, user='Louis')

## Full resolution
# Threshold 1330 for 20 clusters
Clustering(method="maxp", data="af", resize=1, threshold=1325, plot=False, user='Louis')
