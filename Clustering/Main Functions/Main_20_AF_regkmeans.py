...
### Regional Kmeans
## 1/9 resolution
Clustering(method="regional_kmeans", data="af", resize=3, number_of_clusters=20, plot=False)

## 1/4 resolution
Clustering(method="regional_kmeans", data="af", resize=2, number_of_clusters=20, plot=False)

## full resolution
Clustering(method="regional_kmeans", data="af", resize=1, number_of_clusters=20, plot=False)