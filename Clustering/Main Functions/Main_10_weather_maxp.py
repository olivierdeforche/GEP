...
## 1/16 resolution
Clustering(method="maxp", data="weather", resize=4, threshold=2600 / 16, plot=False, user='Louis')
...
# Full resolution
Clustering(method="maxp", data="weather", resize=1, threshold=2695, plot=False, user='Louis')
