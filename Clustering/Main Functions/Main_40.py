...
Clustering(method="maxp", data="af", resize=1, threshold=660, plot=False, user='Louis')
...
### Kmeans++
## full resolution
Clustering(method="kmeans", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmeans", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis')

## 1/4 resolution
Clustering(method="kmeans", data="weather", resize=2, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmeans", data="af", resize=2, number_of_clusters=40, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="kmeans", data="weather", resize=3, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmeans", data="af", resize=3, number_of_clusters=40, plot=False, user='Louis')

### Kmedoids
## full resolution
Clustering(method="kmedoids", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmedoids", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis')

## 1/4 resolution
Clustering(method="kmedoids", data="weather", resize=2, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmedoids", data="af", resize=2, number_of_clusters=40, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="kmedoids", data="weather", resize=3, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="kmedoids", data="af", resize=3, number_of_clusters=40, plot=False, user='Louis')

### Ward
## full resolution
Clustering(method="ward", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="ward", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis')

## 1/4 resolution
Clustering(method="ward", data="weather", resize=2, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="ward", data="af", resize=2, number_of_clusters=40, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="ward", data="weather", resize=3, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="ward", data="af", resize=3, number_of_clusters=40, plot=False, user='Louis')

### Regional Kmeans
## full resolution
Clustering(method="regional_kmeans", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="regional_kmeans", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis')

## 1/4 resolution
Clustering(method="regional_kmeans", data="weather", resize=2, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="regional_kmeans", data="af", resize=2, number_of_clusters=40, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="regional_kmeans", data="weather", resize=3, number_of_clusters=40, plot=False, user='Louis')
Clustering(method="regional_kmeans", data="af", resize=3, number_of_clusters=40, plot=False, user='Louis')
...
Clustering(method="maxp", data="af", resize=1, threshold=, plot=False, user='Louis')
Clustering(method="maxp", data="weather", resize=1, threshold=, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="af", resize=2, threshold= 650 / 4, plot=False, user='Louis')
Clustering(method="maxp", data="weather", resize=2, threshold= 650 / 4, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="maxp", data="af", resize=3, threshold= 650 / 9, plot=False, user='Louis')
Clustering(method="maxp", data="weather", resize=3, threshold= 650 / 9, plot=False, user='Louis')

### Variabiliteitscheck voor beste methode (full resolution)

## Regional K means
##2
Clustering(method="regional_kmeans", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis', iteration=2)
Clustering(method="regional_kmeans", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis', iteration=2)

##3
Clustering(method="regional_kmeans", data="weather", resize=1, number_of_clusters=40, plot=False, user='Louis', iteration=3)
Clustering(method="regional_kmeans", data="af", resize=1, number_of_clusters=40, plot=False, user='Louis', iteration=3)

## MaxP
##2
Clustering(method="maxp", data="af", resize=1, threshold= 650, plot=False, user='Louis', iteration=2)
Clustering(method="maxp", data="weather", resize=1, threshold= 650, plot=False, user='Louis', iteration=2)

##3
Clustering(method="maxp", data="af", resize=1, threshold= 650, plot=False, user='Louis', iteration=3)
Clustering(method="maxp", data="weather", resize=1, threshold= 650, plot=False, user='Louis', iteration=3)
