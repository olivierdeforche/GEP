...
### Regional Kmeans
## full resolution
Clustering(method="regional_kmeans", data="weather", resize=1, number_of_clusters=30, plot=False)

## 1/4 resolution
Clustering(method="regional_kmeans", data="weather", resize=2, number_of_clusters=30, plot=False)

## 1/9 resolution
Clustering(method="regional_kmeans", data="weather", resize=3, number_of_clusters=30, plot=False)
