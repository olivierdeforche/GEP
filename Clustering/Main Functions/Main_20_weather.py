...
## 1/9 resolution
Clustering(method="maxp", data="weather", resize=3, threshold=1325 / 9, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="weather", resize=2, threshold=1325 / 4, plot=False, user='Louis')

# Threshold 1330 for 20 clusters
Clustering(method="maxp", data="weather", resize=1, threshold=1325, plot=False, user='Louis')
