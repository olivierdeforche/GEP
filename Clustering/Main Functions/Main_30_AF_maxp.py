...
## 1/9 resolution
Clustering(method="maxp", data="af", resize=3, threshold=850 / 9, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="af", resize=2, threshold=860 / 4, plot=False, user='Louis')
