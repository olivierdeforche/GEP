...
## 1/16 resolution
Clustering(method="maxp", data="af", resize=4, threshold=830 / 16, plot=False)

## 1/9 resolution
Clustering(method="maxp", data="af", resize=3, threshold=850 / 9, plot=False)

# 1/4 resolution
Clustering(method="maxp", data="af", resize=2, threshold=860 / 4, plot=False)

## Full resolution
# Threshold 865 for 30 clusters, 1 partition
Clustering(method="maxp", data="af", resize=1, threshold=862, plot=False)
