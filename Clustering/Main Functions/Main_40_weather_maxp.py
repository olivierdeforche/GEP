...
## 1/9 resolution
Clustering(method="maxp", data="weather", resize=3, threshold= 630 / 9, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="weather", resize=2, threshold= 640 / 4, plot=False, user='Louis')
