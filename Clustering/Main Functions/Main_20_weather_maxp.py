...
### MaxP
## 1/16 resolution
Clustering(method="maxp", data="weather", resize=4, threshold=1280 / 16, plot=False, user='Louis')

## 1/9 resolution
Clustering(method="maxp", data="weather", resize=3, threshold=1300 / 9, plot=False, user='Louis')

# 1/4 resolution
Clustering(method="maxp", data="weather", resize=2, threshold=1320 / 4, plot=False, user='Louis')
